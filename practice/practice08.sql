--1
select empno,ename,TO_CHAR((sal*12)+comm,'9,999,999') salary from emp where ename='ALLEN';
--2
select empno,ename,hiredate,TO_CHAR((sal*12)+comm,'$9,999,999') sal,TO_CHAR(((sal*12)+comm)*1.15,'$9,999,999') "15%인상" from emp where comm is not null;
/*************************************/
