...
select
    name,
    tel,
    DECODE(SUBSTR(tel,1,INSTR(tel,')')-1),'02','SEOUL','031','GYEONGGGI','051','BUSAN','052','ULSAN','055','GYEONGNAM') 지역명
from student;
/********************************/
--1.
...
select
    ...
    CASE
        ...
        WHEN SUBSTR(jumin,7,1)IN('2','4')THEN '남자'
    END 성별3
from student;
--5.
...
select
    name,
    tel,
    DECODE(SUBSTR(tel,1,INSTR(tel,')')-1),'02)','서울','031','경기','051','부산','052','울산','055','경남') 지역
from student
where deptno1 = 101;
